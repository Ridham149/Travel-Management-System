...
public class CheckPackage extends JFrame{
    CheckPackage(){
        ...
        String[] package3={"BRONZE PACKAGE","6 Days and 5 Nights","Return Airfare","Free Clubbing","Horse Ridding & other games","Hard Drinks Free","Daily Buffet","BBQ Dinner","Book Now","Winter Special","Rs 32000/-","package3.jpg"};
        //tabs bnane ke lye class use krne pdte hai
        ...
        add(tab);
        //sare pack mai data toh same hai,isliye mko data ko dynamic krna pdega,kaise,array bnana pdega
